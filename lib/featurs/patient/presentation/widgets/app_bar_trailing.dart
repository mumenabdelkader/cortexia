import 'package:cortexia/featurs/patient/presentation/ui/new_patient_registration_screen.dart';
import 'package:flutter/material.dart';
import 'package:cortexia/core/thems/color_thems.dart'; // تأكد من استيراد ملف الألوان
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: Colors.white.withOpacity(0.2), // حد فاتح بسيط للتحديد
              ),
            ),
            child: const Row(
              children: [
