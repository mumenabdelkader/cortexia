...
abstract class CaseHistoryService {
  ...
  Future<AddCaseHistoryResponseModel> postAdmissionsAdmissionidCaseHistory({@Path('admissionId') required String admissionid, @Body() required AddCaseHistoryCommandModel requestBody});
