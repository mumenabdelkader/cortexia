...
class DioHelper implements ApiHelper {
  ...
  Future<String?> _getToken() async {
    return SharedPrefHelper.getStringSync("token"); // بدون await
  }
  ...
  Future<Response> postData({
   ...
   dynamic body,
    ...
    return _dio.post(path, data: body ?? bodyFormData, queryParameters: queryParameters);
  }
  @override
  ...
  Future<Response> uploadFile({
    ...
    String fieldName = "File", // حسب اسم الباراميتر في الـ backend
    Map<String, dynamic>? queryParameters,
  }) async {
